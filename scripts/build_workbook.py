...
def aero_book() -> dict:
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Two more practical consequences follow. The first: stall speed rises with altitude. The wing has to fly faster to keep generating enough lift, so the minimum airspeed shifts up. The second: at altitude you can only compensate for the thinner air with speed — everything else (wing area, profile, your weight) stays the same. Choose a steeper launch and run harder, and do not over-brake the wing in the first moments after lift-off."},
...
def meteo_book() -> dict:
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "A cloud is a portion of the atmosphere containing countless tiny droplets of liquid water suspended in the air. Fog and cloud are physically the same thing — fog is just a cloud viewed from the inside. More precisely, fog is defined as a cloud reducing horizontal visibility below 1 km. Mist is a thinner suspension of droplets and particles, defined when visibility is between 1 and 10 km."},
            {"kind": "p", "text": "Cloud forms whenever air is cooled below its dew point. Two main mechanisms produce that cooling. The first is radiation cooling: during long autumn and winter nights the ground emits infrared radiation and gradually cools, the air above it cools too, and if it reaches its dew point, radiation fog forms near the ground. The second is the cooling that comes from rising air, with three main causes: convection (heating from below driving thermals), orographic lift (wind forced upward by terrain like a dam) and frontal lift (warm air sliding up over colder air at a front)."},
            {"kind": "image", "deck": "meteo", "page": 52, "caption": "How cumulus clouds form — thermals rise, reach dew point, condense."},
            {"kind": "image", "deck": "meteo", "page": 62, "caption": "Cloud base — the altitude at which condensation begins."},
            {"kind": "h2", "text": "Cloud names"},
            {"kind": "p", "text": "The Latin naming system uses prefixes for altitude and suffixes for structure. Cirro- means very high cloud, between 6000 and 10000 m, generally thin. Alto- means mid-level cloud, between 3000 and 6000 m. No prefix means low cloud, below 3000 m. The suffixes describe shape and behaviour. Cumulus means ball- or cauliflower-shaped heaped cloud. Stratus means stretched layered cloud. Nimbo- (or -nimbus) means precipitating cloud."},
            ...
            {"kind": "image", "deck": "meteo", "page": 70, "caption": "Cloud names — second page of the visual catalogue."},
            {"kind": "h2", "text": "High clouds — cirrus and cirrocumulus"},
            {"kind": "p", "text": "Cirrus (Ci) are small thin hair-shaped high clouds, between 6000 and 10000 m. Cirrostratus (Cs) is a thin translucent layer at the same altitudes; sunlight passes through with a halo of colours around the Sun. Cirrocumulus (Cc) are small piled-up clouds at the top of the cumulus family, with bases above 6000 m, always made of ice crystals suspended like dust."},
            {"kind": "h2", "text": "Cumulus family — the pilot's friend and foe"},
            {"kind": "p", "text": "Cumulus (Cu) is the classic sign of good thermals. There are three sizes. Cumulus humilis (very small, flat-bottomed) and cumulus mediocris (medium, cauliflower shape) are the indicators of an active thermal day. Their bases lie typically between 1000 and 4000 m depending on humidity and location. Cumulus congestus is much taller and darker-based; it can produce small local showers or grow further into a cumulonimbus."},
            {"kind": "p", "text": "Cumulonimbus (Cb) is the thunderstorm cloud — cumulus congestus that has grown into a huge mushroom-shaped tower reaching up to about 10000 m. The internal updrafts, downdrafts and horizontal currents are much stronger than any paraglider can fly; precipitation, hail and lightning are common. Strong downdrafts during the precipitation phase are caused by cooling from evaporation. A grey curtain of vertical stripes extending from the cloud base to the ground is the visible sign that precipitation is reaching the surface."},
            {"kind": "image", "deck": "meteo", "page": 72, "caption": "Thermals seen as a cumulus picture in the sky."},
            {"kind": "image", "deck": "meteo", "page": 71, "caption": "Cloud coverage — reading the sky for the day's potential."},
            {"kind": "h2", "text": "Mid-level cloud warning signs"},
            {"kind": "p", "text": "Altocumulus castellanus (Ac cas) are tower-shaped clouds with castle-like ramparts that appear early in the morning. They signal unstable, humid air aloft and commonly predict thunderstorm development by mid-afternoon. Lenticular altocumulus (Ac len) are smooth lens-shaped clouds that develop above 3500 m when moderately strong winds flow over mountains, creating standing waves. Despite the wind, the cloud stays stationary because air condenses on the upwind side of the wave and evaporates on the downwind side."},
            {"kind": "p", "text": "Altostratus (As) is a mid-level cloud layer with its base around 4000 m, often heralding an approaching warm front. Altocumulus (Ac) is similar but in piled patches at about 4500 m. Stratus (St) is a low cloud layer often touching the ground — fog from above. Stratus is typical of autumn and winter mornings with a strong inversion in the 1000–1500 m range: sunny at altitude, foggy below. Stratocumulus (Sc) is low banded cumulus common after rain. Nimbostratus (Ns) is a very thick low cloud layer producing extended steady precipitation, base around 1000 m."},
            {"kind": "image", "deck": "meteo", "page": 68, "caption": "Cloud naming grid — altitudes and shapes side by side."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Wind direction is conventionally given as the compass direction from which the wind is blowing — a north wind blows from north toward south. Directions are stated in degrees from 0 (north) clockwise through 90 (east), 180 (south) and 270 (west). Wind speed is measured by an anemometer and reported in km/h, m/s or knots. A useful conversion: 1 knot ≈ 1.85 km/h, so 10 knots is about 18 km/h."},
            {"kind": "image", "deck": "meteo", "page": 30, "caption": "Wind direction — given as the direction the wind is FROM."},
            {"kind": "image", "deck": "meteo", "page": 31, "caption": "Wind strength — conversion between knots, m/s and km/h."},
            {"kind": "h2", "text": "Why pressure varies — and how to compare"},
            {"kind": "p", "text": "Not all locations are at sea level, so the pressure measured locally cannot be compared directly: the highest station always reads the lowest pressure. Meteorologists therefore correct every reading to its sea-level equivalent before plotting it on a map. Even at sea level, atmospheric pressure varies from place to place and from one moment to another, because changes in land temperature warm or cool the air in contact with the ground, which then varies in density and pressure."},
            {"kind": "p", "text": "An area of high pressure tends to form over land that is cooler than its surroundings for a long period — the Arctic, Siberia, any continent in winter, or an ocean during summer that is cooler than the neighbouring continents. Conversely, a low pressure area (depression) forms over a region warmer than its surroundings — the equator, the Sahara in summer, or the Atlantic in winter. These persistent highs and lows are called centres of action because they drive the general atmospheric circulation."},
            {"kind": "h2", "text": "Isobars and typical pressures"},
            {"kind": "p", "text": "An isobar on a weather map is a line connecting points of equal sea-level-corrected pressure. Isobars are typically drawn every 5 hPa. The average sea-level pressure on land is around 1015 hPa. A strong winter anticyclone can reach 1030 to 1040 hPa; higher values are very rare. Summer highs are generally lower, around 1020 to 1025 hPa. A pressure of 955 hPa would be typical of a deep depression."},
            ...
            {"kind": "image", "deck": "meteo", "page": 29, "caption": "Reading an isobar chart in detail."},
            {"kind": "p", "text": "Closely packed isobars mean a steep horizontal pressure gradient and strong winds. Widely spaced isobars mean a weak gradient and light winds. The strength of the wind at a given place can be read directly off the chart by looking at how tightly the contours are packed near that place."},
            {"kind": "image", "deck": "meteo", "page": 27, "caption": "Wind strength — tighter isobars mean stronger gradient wind."},
            {"kind": "image", "deck": "meteo", "page": 28, "caption": "Strength of high and low pressure systems."},
            {"kind": "h2", "text": "Coriolis and geostrophic wind"},
            {"kind": "p", "text": "Because the Earth rotates, moving air in the northern hemisphere is deflected to the right of its direction of motion. This interferes with the direct movement of air between centres of action and gives the wind a rotational character. Wind rotates clockwise around a high (anticyclone) and anti-clockwise around a low (cyclone) in the northern hemisphere. A memory aid: keep 'anti-' in the middle — anti-cyclone clockwise, cyclone anti-clockwise. In the southern hemisphere it is reversed."},
            {"kind": "image", "deck": "meteo", "page": 24, "caption": "Rotation imposed by the Coriolis force."},
            {"kind": "image", "deck": "meteo", "page": 25, "caption": "Coriolis on a real chart example."},
            {"kind": "p", "text": "High in the atmosphere, well above the friction of the ground, wind blows parallel to the isobars — this is the geostrophic wind. Three principles describe it. Wind direction is parallel to the isobars. Wind rotates clockwise around a high, anti-clockwise around a low (northern hemisphere). Wind strength is determined by isobar spacing. Nearer the surface, friction slows the wind and tilts it slightly toward the low — typically a few degrees over flat ground."},
            {"kind": "image", "deck": "meteo", "page": 26, "caption": "Wind from pressure equalisation — between high and low."},
            {"kind": "image", "deck": "meteo", "page": 32, "caption": "Wind profile over the ground — friction slows the lowest layers."},
            {"kind": "h2", "text": "Anticyclones vs depressions"},
            {"kind": "p", "text": "An anticyclone (high) is a region where the air falls, heats by compression and dries out. In Europe there is often a temperature inversion accompanying a high pressure region, typically between 1500 and 2000 m. Anticyclonic weather is therefore rather stable with a convective layer of modest depth. A depression (cyclone) is a region of rising air: the air cools, increases its humidity and the weather conditions are unsettled, often cloudy or rainy."},
            {"kind": "p", "text": "Between these two extremes is the 'barometric swamp' — a wide region of intermediate pressure (1010 to 1020 hPa) with widely spaced isobars. Air density is lower, the atmosphere is more unstable, more humid and more volatile than in an anticyclone, while winds are light because the pressure gradient is small or zero. The barometric swamp is one of the best paragliding situations, with good convection and high thermal ceilings — but the risk of local afternoon thunderstorms is real."},
            {"kind": "image", "deck": "meteo", "page": 15, "caption": "Formation of polar and tropical air masses & pressure systems."},
            {"kind": "image", "deck": "meteo", "page": 18, "caption": "Formation of thermal high and low pressure."},
            {"kind": "image", "deck": "meteo", "page": 20, "caption": "How wind forms — pressure equalisation in action."},
            {"kind": "callout", "title": "Pressure essentials", "items": [
                ...
                "Barometric swamp (1010–1020 hPa, light winds): often the best PG day, but local Cb risk.",
            ]},
        ],
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Beyond the general geostrophic circulation, regional air movements develop on a mesoscale and microscale. The classic alpine example is the alternation of valley wind by day and mountain wind by night. The valley wind blows from the main, wide section of a valley up toward its upper reaches with their small side valleys and peaks, which warm up faster than the broader main valley."},
            {"kind": "p", "text": "Since the valley wind is driven by solar intensity and is enhanced by ground that is free of snow, it is strongest in July and August and weakest in December and January. It is also at its strongest in mid-afternoon when the sky is clear. In summer it begins in the late morning and typically lasts until evening. With altitude the valley wind is stronger, but in wide valleys it gradually disappears around 2000 m, where the prevailing synoptic wind takes over."},
            ...
            {"kind": "image", "deck": "meteo", "page": 80, "caption": "Eastern Switzerland — regional winds in detail."},
            {"kind": "h2", "text": "Mountain wind (katabatic)"},
            {"kind": "p", "text": "After sunset each valley wall is cooled by nocturnal radiation. Cold, dense air slides down the slopes and accumulates at the bottom of the valley, then flows down-valley toward the broader and deeper main valley which cools more slowly. This is the katabatic mountain wind. It is generally lighter than the daytime valley wind, beginning typically around 18–19 h in summer, but can build into surprisingly strong drainage flows on long deep valleys."},
            {"kind": "image", "deck": "meteo", "page": 79, "caption": "Mountain wind — cold air draining downslope after sunset."},
            {"kind": "p", "text": "Sometimes the convergence of evening downslope breezes from both sides of a valley generates a slight upward current in the middle, which can be just strong enough to keep a glider aloft for tens of minutes after sunset — locally known as 'rendition' lift."},
            {"kind": "h2", "text": "Föhn — the ingredients"},
            {"kind": "p", "text": "Föhn is a warm, dry, gusty downslope wind. The classic ingredients are three: a strong pressure difference across the mountain chain, moist air on the windward side, and a barrier tall enough for the air to release its moisture as it rises. On the windward side the moist air ascends, condenses and drops its water as rain — cooling at the slow moist adiabatic rate of about 0.6 °C / 100 m. The cloud clings to the ridge and forms a compact band at the crest called the Föhn wall."},
            ...
            {"kind": "p", "text": "On the lee side the now-dry air descends, warming at the fast dry adiabatic rate of 1 °C / 100 m. Because moisture has been removed on the way up, the descending air arrives much warmer and drier than the air that started on the windward side. It is also strong and gusty, with violent turbulence. The conclusion is simple: if the Föhn is active, do not fly, even if 'the weather looks good'."},
            {"kind": "h2", "text": "Südföhn and Nordföhn"},
            {"kind": "p", "text": "Südföhn blows from the south across the Alps. It is driven by a depression over northwest Europe and higher pressure over northern Italy. On the ground there is a strong south-north pressure difference above 5 hPa — for example 1010 hPa at Zurich and 1019 hPa at Lugano. The effect is clouds and heavy rain on the southern slopes, strong winds, high temperatures and sunny dry conditions north of the Alps. Risk is concentrated in the northern Alpine valleys where the fine weather may tempt the pilot to fly."},
            {"kind": "p", "text": "Nordföhn is the mirror image: an Azores-area anticyclone extends north and east, often with a depression over Eastern Europe. The ground pressure difference reverses: 1023 hPa Zurich and 1015 hPa Lugano (north higher). Clouds and rain accumulate on the north side, while warm dry sunny weather and high winds develop on the south side, especially in Ticino. Risk is again on the sunny side where flying looks deceptively safe."},
            ...
            {"kind": "p", "text": "Föhn produces strong turbulence, rotor downwind of the mountains and rapid changes in wind direction. Visible warning signs include the Föhn wall (a stationary cloud bank piled on the windward side of the ridge), lenticular clouds in the lee, sudden clarity of the air at altitude and rapidly rising temperature in the lee valleys. The classic synoptic signature is a north-south pressure difference above 5 hPa between Zurich and Lugano."},
            {"kind": "image", "deck": "meteo", "page": 85, "caption": "Föhn — cloud pictures that announce it."},
            {"kind": "callout", "title": "Local winds checklist", "items": [
                "Valley wind: anabatic, strongest mid-afternoon, July–August.",
                "Mountain wind: katabatic, starts ~18–19 h after sunset.",
                ...
                "Δp Zurich–Lugano > 5 hPa: Föhn likely.",
            ]},
        ],
    ...
    chapters.append({
        ...
        "title": "Turbulence",
        "subtitle": "Mechanical, shear and thermal",
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Turbulence is the local variation, eddying and abrupt change in wind direction and speed that the atmosphere produces when smooth flow is disturbed. It is fundamentally driven by wind: the stronger the wind, the greater the chance of turbulence and the more violent it can be. Flying in strong winds, or in areas prone to strong winds (a narrowing or a curve of a valley), is therefore unwise. Storms are particularly bad because they are often associated with episodes of strong, irregular gusts; pilots should land quickly when storms approach."},
            {"kind": "image", "deck": "meteo", "page": 33, "caption": "Turbulence — air motion irregular in speed and direction."},
            {"kind": "p", "text": "Meteorologists classify turbulence into three types according to origin: mechanical turbulence (wind meeting solid obstacles), shear turbulence (between layers of different wind speed or direction) and thermal turbulence (between warm rising and cool descending air)."},
            {"kind": "h2", "text": "Mechanical turbulence"},
            {"kind": "p", "text": "Mechanical turbulence is the result of conflict between solid obstacles and wind. Objects upwind of a reference point are described as 'windward'; objects downwind are 'leeward'. The air leeward of an obstacle has the most marked turbulence — rotor flow that may extend horizontally up to ten times the obstacle's height downwind. It is therefore dangerous to fly leeward of a mountain, a building or any tall obstacle, and this should be avoided at all costs, including in the choice of landing sites."},
            {"kind": "p", "text": "Where wind is forced over a relief, there is a constriction in the airflow above and just behind the edge, and the air is forced to increase its speed. This phenomenon of increased air speed where the flow area decreases is the Venturi effect. The Venturi effect does not only occur above and behind mountain peaks but also wherever wind is forced into a narrow valley or around a ridge — a strong contributor to turbulence around mountain passes and gaps."},
            {"kind": "image", "deck": "meteo", "page": 34, "caption": "Venturi effect — wind accelerates through narrow gaps."},
            {"kind": "h2", "text": "Shear turbulence"},
            {"kind": "p", "text": "Shear turbulence occurs close to the boundary between two air masses subjected to winds of different speed or direction. A typical example: a 10–15 knot north-easterly wind at 1000 and 2000 m, with a southwesterly 10 knots at 3000 and 4000 m — between 2000 and 3000 m there is a sharp change of direction that produces shear turbulence at the boundary."},
            {"kind": "p", "text": "When wind speed alone decreases without changing direction, the result is a 'gradient wind' — most marked near a flat surface where the wind a few centimetres above the ground is hampered by friction while the wind tens of metres above is much stronger. The wind gradient near the ground can therefore be a source of significant shear turbulence on take-off and landing."},
            {"kind": "h2", "text": "Thermal turbulence"},
            {"kind": "p", "text": "Thermal turbulence occurs at the boundary between warm, rising air and cool, descending air. It is also strong at the top of the convective layer, where rising thermals meet stable air aloft. Thermal turbulence is therefore strongest at the times and places where convection is most active — typically mid-afternoon on sunny days, where sun and shadow alternate, and in valleys where the valley wind meets thermals from south-facing slopes."},
            {"kind": "p", "text": "In a typical alpine summer afternoon you may meet all three kinds of turbulence in a single hour. Near the ground (within 20 m): mainly mechanical from terrain and vegetation. Around 500 m above a valley with a developed valley wind: shear turbulence between the valley wind and the prevailing wind aloft. Above a south slope at 2800 m on a sunny day: thermal turbulence dominates."},
            {"kind": "callout", "title": "Turbulence types", "items": [
                "Mechanical: wind + obstacles → rotors downwind, up to 10× obstacle height.",
                "Shear: layers with different wind speed/direction → boundary turbulence.",
                "Thermal: rising bubbles → gusts in convective sky.",
                "Venturi: wind accelerated through narrow gaps.",
            ]},
        ],
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "An air mass is an extensive body of air — a continental scale of hundreds or thousands of kilometres — with relatively uniform characteristics, especially temperature and humidity, extending horizontally to its boundaries. Examples are a polar maritime air mass (cold and wet) or a tropical continental one (hot and dry). An air mass is described as 'warm' when its temperature is higher than that of its neighbours, regardless of what an absolute thermometer says."},
            {"kind": "p", "text": "Air masses do not mix easily. There is a relatively clear separation between two distinct air masses, called a front. Fronts are found mainly in temperate regions like Europe, where cold polar and warm tropical air masses meet. In polar, equatorial or tropical regions, fronts are essentially absent because all the air is of the same character."},
            {"kind": "image", "deck": "meteo", "page": 15, "caption": "Formation of polar and tropical air masses."},
            {"kind": "image", "deck": "meteo", "page": 16, "caption": "Polar and tropical air mass formation — global picture."},
            {"kind": "image", "deck": "meteo", "page": 37, "caption": "Boundary between two air masses — sloped, not vertical."},
            {"kind": "image", "deck": "meteo", "page": 38, "caption": "Boundary between air masses — a closer look."},
            {"kind": "h2", "text": "How fronts form in a depression"},
            {"kind": "p", "text": "At our latitudes, depressions and frontal systems usually move from west to east at a few kilometres per hour. The anti-clockwise rotation of winds around a depression, combined with the eastern trajectory of the depression itself, drives the cold air west of the depression toward the southeast — forming a cold front — while warm air on the east side heads north, forming a warm front. Both fronts slant toward the cold air."},
            {"kind": "image", "deck": "meteo", "page": 36, "caption": "How fronts form — cyclone rotation drives both fronts."},
            {"kind": "image", "deck": "meteo", "page": 40, "caption": "Cyclonic influence — depressions drive the front system."},
            {"kind": "image", "deck": "meteo", "page": 41, "caption": "Front formation under a cyclone — close-up."},
            {"kind": "h2", "text": "Warm front"},
            {"kind": "p", "text": "A warm front occurs when warm, less dense air moves over the top of retreating cold air, sliding gently up the slope. Because the slope is gentle and the air mass is slow, an observer on the ground first sees the warm front high overhead, then watches it descend as the front passes. Cool air rises by expansion, water vapour saturates, clouds form and rain falls."},
            {"kind": "p", "text": "The cloud sequence in front of a warm front is a textbook display: high cirrus first, then cirrostratus and stratus, then altocumulus, and finally nimbostratus with rain at the front itself. Just before the warm front arrives on the ground, clouds are low and produce rain, visibility is poor and the wind strength increases. The whole sequence can stretch over hundreds of kilometres; the precipitation lasts for hours."},
            ...
            {"kind": "p", "text": "A cold front occurs when cold, denser air slides violently under warm air it encounters. The boundary is much steeper than for a warm front; the warm air is shoved abruptly upward. Cloud is shorter in horizontal extent but much taller. The front is characterised by a barrier of cumulonimbus coming from the west, often with thunderstorms, sharp gusts and rapid temperature drop. The passage is brutal but brief — typically minutes to an hour at any point."},
            {"kind": "p", "text": "The hours before a cold front can be calm and even sunny, then the front and its barrier of cumulonimbus arrive, sometimes with lightning, thunder and hail. Behind the cold front the trailing air is fresher, with good visibility and stratocumulus or shallow cumulus at modest altitude. Cumulonimbus and thunderstorms are more likely in summer cold fronts than winter ones, because the lower atmosphere is warmer. Meteorological forecasts that mention 'fresh polar air arriving in a hot stuffy summer' usually mean a cold-front passage with thunderstorms, hail and gusty winds."},
            ...
            {"kind": "image", "deck": "meteo", "page": 46, "caption": "Active front vs. just a brush — how to tell."},
            {"kind": "h2", "text": "Occlusion"},
            {"kind": "p", "text": "The cold front moves slightly faster than the warm front. Eventually the cold front catches up with the warm front and the two merge — this is called an occlusion. Depending on the relative temperature of the cold air behind the cold front and the cold air ahead of the warm front, an occlusion presents either warm-front or cold-front characteristics at ground level."},
            {"kind": "p", "text": "If the cold air behind the cold front is warmer than the cold air ahead of the warm front, the cold front slides over the warm front and the conditions at ground level remain warm-front in character. If the situation is reversed and the trailing cold air is colder, the cold front slips under the warm front and the occlusion presents cold-front character at ground level."},
            {"kind": "image", "deck": "meteo", "page": 42, "caption": "Formation of an occlusion — cold front overtakes the warm front."},
            {"kind": "image", "deck": "meteo", "page": 43, "caption": "Well-developed occlusion — composite weather."},
            {"kind": "image", "deck": "meteo", "page": 49, "caption": "Occlusion — combined warm+cold front character."},
            {"kind": "image", "deck": "meteo", "page": 50, "caption": "Occlusion — cloud images of the merged front."},
            {"kind": "image", "deck": "meteo", "page": 39, "caption": "Polar front / stationary front — when fronts don't move."},
            {"kind": "callout", "title": "Front facts", "items": [
                "Warm front: gentle slope, high cirrus first, long steady rain.",
                "Cold front: steep slope, towering Cb, brief violent passage.",
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "For strong thermals to develop over a land surface, two ingredients are needed. First, strong solar radiation arriving essentially perpendicular to the surface — for instance mountain faces in the morning, southern slopes around noon, western slopes in the afternoon. Second, ground that absorbs solar radiation efficiently: dark, rough, dry surfaces warm the air well; reflective surfaces such as snow waste much of the incoming light; wet ground spends a large fraction of the energy on evaporation."},
            {"kind": "p", "text": "Powerful convection in a humid atmosphere can build cumulus humilis through mediocris into a cumulus congestus and then a cumulonimbus producing rain, gusts and thunder — a heat storm. Heat storms usually develop in late afternoon, when the ground has had hours of sun to fuel convection. They are local, often isolated, but extremely dangerous within tens of kilometres because of strong inflow, downdrafts and gust fronts."},
            {"kind": "image", "deck": "meteo", "page": 73, "caption": "Thunderstorm formation — congestus building into Cb."},
            {"kind": "image", "deck": "meteo", "page": 74, "caption": "Thunderstorm formation — second stage of growth."},
            {"kind": "image", "deck": "meteo", "page": 75, "caption": "Thunderstorms — mature and decaying stages."},
            {"kind": "image", "deck": "meteo", "page": 76, "caption": "Thunderstorm hazards — gusts, hail, lightning."},
            {"kind": "p", "text": "A 'blue thermal' is convection that does not result in cumulus at the top. It occurs when the air is very dry — a low humidity or a wide gap between temperature and dew point — so condensation does not happen at the thermal top. Frontal thunderstorms, by contrast, are not tied to time of day. They are triggered by the violent uplift of warm humid air at a cold front and can occur day or night."},
            {"kind": "p", "text": "Convective activity in Europe is best from April to August because solar radiation is stronger and the days are longer. Differences in average altitude shift the peak: snowmelt and thermals come earlier in the pre-Alps than in the Alps, so thermals are best in May in the pre-Alps and in August in the Alps."},
            {"kind": "h2", "text": "Synoptic maps"},
            {"kind": "p", "text": "A synoptic chart summarises the state of various meteorological features at a given time — pressure as isobars, fronts as marked lines, and sometimes wind, temperature and cloud. The letter H marks the centre of a high (anticyclone), the letter L the centre of a low (depression). The line styles distinguish warm fronts, cold fronts and occlusions. Pressures shown on the map are corrected to sea level."},
            ...
            {"kind": "p", "text": "Three things on a synoptic map answer most flying questions. Isobar spacing indicates the pressure gradient and therefore the wind strength. Centres of action (H and L) determine the wind rotation: clockwise round a high, anti-clockwise round a low (northern hemisphere). The position and movement of fronts determine the next 24 hours of weather."},
            {"kind": "h2", "text": "Typical Swiss situations"},
            {"kind": "p", "text": "From the synoptic maps over Europe we can identify six weather patterns typical for Switzerland. An anticyclone centred on the Alps gives stable weather: in winter, pressures of 1030–1040 hPa, often with strong inversion and stratus on the plateau; in summer, around 1020–1025 hPa, with usable thermals in the Alps and possible local thunderstorms. A barometric plateau gives light winds and good thermals but a real thunderstorm risk in the afternoon."},
            {"kind": "p", "text": "The Bise is a pronounced wind from the north-east on the central plateau around 2000 m, caused by a high pressure centred north of Germany. Westerly flow comes with a depression over Scandinavia: short periods of good weather alternate with disturbances, often with strong winds. The two Föhn situations — Südföhn (depression northwest, high over northern Italy, with south wind across the Alps) and Nordföhn (Azores high extending east, with north wind across the Alps) — are characterised by strong south-north pressure differences and dangerous turbulence."},
            ...
            {"kind": "image", "deck": "meteo", "page": 17, "caption": "Polar and tropical air mass formation in pressure systems."},
            {"kind": "image", "deck": "meteo", "page": 19, "caption": "Thermal high and low pressure formation."},
...
def law_book() -> dict:
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Every slope glider must carry two sets of markings: an identification number and a manufacturer's plaque. The identification number is composed of five or more digits, must be easily recognisable, and is affixed to the underside of the wing. The digits are usually adhered to the fabric and each must measure 40 cm in height. The SHV/FSVL manages and allocates these numbers; in practice the number is usually the same as the pilot's SHV/FSVL licence number."},
            {"kind": "p", "text": "The manufacturer's plaque is a small piece of fabric sewn into an edge or wingtip and must include the manufacturer's name, the type of wing, the year of manufacture, and the minimum and maximum loads specified by the manufacturer. Other items such as serial numbers or class certification are not mandatory. All wings flown by the same pilot must carry the same identification number — identical to the number on the certificate of liability insurance, which the pilot must carry on every flight."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "A NOTAM (Notice to Airmen) is an official short-term notice about changes to airspace, hazards or operations. The DABS (Daily Airspace Bulletin Switzerland) lists daily Swiss airspace activations and is read by virtually every Swiss pilot before flying. The AIP (Aeronautical Information Publication) is the master reference document for the Swiss airspace structure. The HX suffix on an airspace label means the airspace is active on demand, not by a fixed schedule."},
            {"kind": "p", "text": "Three additional acronyms turn up regularly. FIZ is a Flight Information Zone — radio contact recommended, not strictly mandatory. RMZ is a Radio Mandatory Zone — radio contact required. ATIS is the Automatic Terminal Information Service, the recorded weather broadcast for an airport that pilots tune in before any controlled-airspace contact."},
            {"kind": "h2", "text": "Flight levels and rules"},
            {"kind": "p", "text": "FL stands for Flight Level — altitude in hundreds of feet referenced to the standard pressure of 1013.25 hPa. To convert a Flight Level to approximate metres, multiply the number by 30: FL30 ≈ 900 m, FL100 ≈ 3000 m, FL150 ≈ 4500 m, FL195 ≈ 5900 m. VFR means Visual Flight Rules: see and avoid is the pilot's job. IFR means Instrument Flight Rules — paragliders never fly IFR. The 'LS' prefix in ICAO codes refers to Switzerland — every Swiss aerodrome's identifier begins with LS (LSZH = Zurich, LSGG = Geneva)."},
            {"kind": "p", "text": "Two more altitude references are vital: AGL stands for Above Ground Level, used for the 600 m upper limit of airspace G. AMSL stands for Above Mean Sea Level, used for almost every other altitude. The HX suffix on an airspace label means the airspace is active on demand, not by default. GND simply means Ground."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "ICAO has legally defined seven airspace classes in the troposphere, designated by the letters A to G. In Switzerland only four of these classes apply: C, D, E and G. The spaces E and G are uncontrolled — they are the only airspaces a paraglider may use without permission and without radio contact. The spaces C and D are controlled airspace, requiring prior authorisation and continuous radio contact, and paragliders should not use them. A useful memory aid: 'Ceiling Defines Every Glide.'"},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "The AIP is the official Aeronautical Information Publication: the long-form reference describing the structure of every airspace, navaid and aerodrome in Switzerland. It is the master document that the glider chart summarises in visual form. NOTAMs (Notices to Airmen) are short-term operational notices about temporary changes — short closures, special events, hazards, runway works. The VFR-NOTAM and KOSIF publications focus on items relevant to VFR and to military flying respectively."},
            {"kind": "h2", "text": "Aerodromes and heliports"},
            {"kind": "p", "text": "Aerodromes and heliports are marked on the chart with their exclusion circles: paragliders may not take off or land within 5 km of an aerodrome's runway (without CTR clearance) and within 2.5 km of a heliport. A small number of heliports have special rules — for instance Trogen, where the protective radius is set differently from the default."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "In a thermal, all gliders circle the same direction — the one used by the first arrival. Joining a thermal in the opposite direction is forbidden and the most common cause of collisions in soaring. Watch other pilots inside and outside the thermal at all times."},
            {"kind": "h2", "text": "Altimetry"},
            {"kind": "p", "text": "Below the transition altitude, altimeters are set to QNH and altitudes are read in metres or feet AMSL. Above that, altimeters are set to the standard pressure 1013.25 hPa and the indication is called a Flight Level. A change of 1 hPa equals about 8 m or 28 ft. With QNH 1015 reported (above standard), you actually fly slightly higher than your altimeter shows when set to 1013."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "The OACS makes pilots responsible for respecting wildlife. The map.geo.admin.ch viewer shows wildlife reserves where flight is restricted. Pilots are expected to keep clear of golden eagle nesting areas — especially March to May, when the eagles are raising young — and to avoid chamois and ibex on south slopes in winter and spring, when their energy reserves are critical for survival. A territorial golden eagle marks its area with a characteristic undulating flight pattern; if you see one, give it space."},
            {"kind": "p", "text": "Beyond wildlife, the OACS sets a small number of common-sense rules that apply on every flight: do not fly over outdoor crowds, do not fly over public roads or ski slopes at low altitude, do not take off or land on water surfaces. The penalties for breaches range from fines to licence withdrawal, and most importantly any incident will be investigated against these rules."},
...
def equip_book() -> dict:
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "A complete paraglider system consists of five main parts. The wing is the canopy itself: a fabric airfoil with internal cells, ribs and Mylar reinforcements at the leading edge. The lines connect the wing to the risers — sheathed thin cords arranged in groups A (front), B, C and sometimes D (rear), plus the steering lines that run to the brake handles. The risers are strong webbing strips ending in karabiner attachment loops; they are where the lines collect together before they meet the pilot."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Anterior cell walls near the openings are often reinforced with Mylar to keep the leading edge shape rigid even when not flying. Mylar is stiff but brittle — repeated folding bends and eventually breaks it, which is why you should never pack a wing with sharp creases at the leading edge."},
            {"kind": "p", "text": "Cell walls can suffer downward loads in certain manoeuvres — for instance during a B-stall, where the cells lose internal pressure and can deform negatively. Diagonal V-ribs (sometimes called Diagonals) carry load from one rib to another, reducing the number of attachment points and lines needed for the same span and the same load-distribution accuracy."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Lines stretch over their lifetime; some materials, especially aramid, can also shrink. UV exposure and repeated loading both degrade the core. With moderate brake input the D-lines may be loose (not under tension) — this is normal and means the wing is in a brake-induced angle-of-attack range where lift has shifted forward toward the leading edge. Sustained sagging beyond expectation, however, can indicate a stretch problem that warrants a workshop check."},
            {"kind": "p", "text": "Routine line check before flight: scan each line from riser to wing for cuts, abrasions, missing sheath, or knots. A nick that exposes the core is enough to scrap the line. Lines that have been heavily exposed to sun and seawater age much faster than the wing itself; on coastal or tropical wings, lines are often the first part to need replacement."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "The reserve must attach high on the shoulder straps of the harness so that, when it deploys, it pulls the pilot upright into the suspended position under the open canopy. Attaching the reserve bridle to the riser karabiners instead leaves the pilot seated in the harness — a poor body position for the deceleration and landing roll. Reserve handle placement should always allow the pilot to find and grasp the handle with one hand in any flight orientation."},
            ...
            {"kind": "p", "text": "Reserve fabric is elastic nylon ripstop, unlike the inelastic wing fabric. The elasticity softens the opening shock, which would otherwise injure the pilot. The target sink rate for a deployed reserve is about 5 to 6 m/s — equivalent to dropping from about 1.5 m. The pilot should land with a parachute landing roll (PLF) to absorb the impact through the entire body rather than just the legs."},
            {"kind": "h2", "text": "Pull-down-apex and opening time"},
            {"kind": "p", "text": "A pull-down apex design (a cord that pulls the centre of the parachute downward in flight) lowers the sink rate but makes the canopy slightly less stable. Opening time improves with low fabric porosity, short repack intervals, more relative airflow at deployment, and smaller canopy area. It worsens with high porosity, long intervals between repacks, slow airspeed at deployment, and large canopy area."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "An altimeter reads altitude by measuring static air pressure and converting it via the standard atmosphere model. Its setting matters: with QNH it shows altitude above mean sea level; with the standard 1013.25 hPa setting it shows Flight Levels. Because pressure varies day to day, a reading taken in the morning at a high-pressure site will drift as a depression approaches: if the high is weakening, the altitude reading at a fixed location will gradually increase over the day even though you have not moved."},
            {"kind": "p", "text": "The altimeter is the basic safety instrument for respecting airspace limits. Before any flight, set the QNH from a nearby reported airfield or from your own measurement at a known point of elevation."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "EN homologation is a test programme in which the wing is subjected to a standardised series of manoeuvres — collapses, stalls, spirals — and graded on its recovery behaviour from A (most docile) to D (most demanding). The certification applies to a specific wing model, size and weight range; flying outside the certified weight range invalidates the certification. Certification tells the buyer about the wing's behaviour in tested manoeuvres — not its absolute performance and not its absolute safety."},
...
def skills_book() -> dict:
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Three forms of hypoxia matter for pilots. Instantaneous hypoxia begins from about 4000 m AMSL: the first symptom is often euphoria — a deceptive sense of well-being — followed by fatigue, slowed thinking, convulsions, coma and death by about 7000 m. Acute mountain sickness develops over 5 to 10 hours after climbing to 2800–3500 m: headache, nausea, occasional edema. Chronic hypoxia is the adaptation seen in long-term high-altitude residents — not the pilot's problem on a normal flight."},
            {"kind": "p", "text": "The treatment for hypoxia is one thing only: lose altitude rapidly. Sensitivity to hypoxia is increased by lack of fitness, medication, alcohol, tobacco, fatigue and lack of sleep. It is reduced by endurance training and by gradual acclimatisation over days to weeks. A healthy resting body can typically adapt to changes up to about 4000 m AMSL without issue."},
            {"kind": "h2", "text": "Pressure equalisation"},
            {"kind": "p", "text": "Sinus and ear pressure pain during altitude change occur when the Eustachian tubes cannot equalise pressure — typically because of a cold, sinusitis or ear infection. A pilot flying with a heavy cold and middle-ear infection risks barotrauma, severe pain and damage to the eardrum. The safe rule is to not fly with any condition affecting your sinuses or ears."},
            ...
            {"kind": "p", "text": "Signs of severe shock include pale skin, bluish lips, cold sweat, weak rapid pulse and partial unresponsiveness. For helicopter rescue, all flying activity in the area must stop and any loose fabric — paragliders, clothing — must be cleared from the landing zone before the helicopter approaches."},
            {"kind": "p", "text": "Carrying a basic first-aid kit, a charged mobile phone with the European emergency number 112 and the Swiss alpine rescue number 1414, and warm clothing for an injured friend, are simple precautions every alpine pilot should take. After any non-trivial accident, document the conditions and circumstances while they are fresh — they help both the official investigation and your own learning."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Good preparation at home covers four areas. Weather: synoptic situation, local forecast, expected wind, instability and risk of thunderstorms. Legal and airspace situation: active LS-R, DABS, MIL hours and any temporary changes. Obstacles and terrain: cables, antennas, terrain steepness, possible alternate landings. Wildlife: nesting areas, seasonal restrictions for chamois and ibex. All four interact — a weather change can suddenly turn a previously safe landing into a hazardous one."},
            ...
            {"kind": "p", "text": "QNH is the sea-level-corrected pressure reading reported by an airport. For example, Zurich-Kloten at about 432 m AMSL might read 950 hPa actual but 1015 hPa QNH. The pressure difference between stations indicates the slope of the isobars — a north-south difference between Zurich and Lugano of more than 4 hPa, with higher pressure in the north, is the classic threshold for Nordföhn risk in Ticino. Higher pressure in the south is the threshold for Südföhn risk on the north side of the Alps."},
            {"kind": "h2", "text": "Documents and bulletins"},
            {"kind": "p", "text": "The most important reference documents for flight planning are the Swiss Glider Chart (airspaces, hours, frequencies, cable obstacles), the AIP, the VFR-NOTAM (active CTRs/TMAs), the KOSIF (military shooting framework) and the DABS. None of them replaces the others — each carries information the others do not. Cross-check all of them before any flight in unfamiliar terrain."},
            {"kind": "h2", "text": "On site at the flying area"},
            {"kind": "p", "text": "On arrival, pre-inspect the take-off and landing fields, identify possible landing wind directions, and note all obstacles. No flight registration is required, but you should be familiar with cable and antenna positions, ridge profiles and obstacles that may channel wind. Pilots like to say the flight starts at the landing field, because that is where you assess wind, traffic and alternate options before going up to launch."},
            ...
            {"kind": "p", "text": "Golden eagles in the Alps nest between March and May. Avoid flying near nesting cliffs in spring. A territorial golden eagle marks its area with a characteristic undulating flight. Eagles mature at five years and remain monogamous for life, defending a territory of about 100 km². Chamois and ibex live on south slopes in winter and spring, and retreat to shaded cliffs in summer — keep distance especially in cold months when their energy reserves are critical."},
            {"kind": "h2", "text": "The main danger"},
            {"kind": "p", "text": "Across years of accident data, the strongest and most prevalent danger for paraglider pilots is strong wind combined with turbulence — especially in alpine terrain. Conservative wind limits, early decisions and the willingness to walk down are the single most important habits of long-flying pilots. No flight is worth a serious injury."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "The five-point check must be performed in order, every flight. First, equipment: harness leg straps closed, chest strap closed, helmet on, reserve handle in place and unobstructed. Second, risers and lines: lines untwisted and free, brake handles in hand, risers correctly attached. Third, wing: shape correct, no twists, leading edge open and facing the wind. Fourth, wind: direction, speed, gusts and consistency. Fifth, airspace: take-off and approach lanes clear of other traffic."},
            ...
            {"kind": "p", "text": "Every paraglider launch has the same three phases. Phase 1: inflation and raising the wing — pull the A risers to inflate the cells and let the wing come up overhead. Phase 2: check and correct — verify the wing is symmetric, level, fully inflated, and that no lines are knotted. Phase 3: accelerate and lift off — commit forward, accelerate to take-off speed, and let the wing lift you off."},
            ...
            {"kind": "p", "text": "Each launch slope has two virtual lines. The decision line is the last point at which you can comfortably abort: if the wing is not right by this point, stop. The point of no return — sometimes called the life line — is the last point before you must be airborne; beyond it, you cannot safely stop. The abort decision must be made before phase 3 begins."},
            {"kind": "h2", "text": "Wind for take-off"},
            {"kind": "p", "text": "Ideal headwind for a forward launch is around 15 km/h. A light tailwind of more than 5 km/h should normally cause an abort: ground speed is too high for safe ground handling and there is insufficient relative airflow over the wing. A sidewind requires inflating the wing into the wind and then pivoting toward the slope. Strong headwind of 20 to 25 km/h calls for a reverse (back-to-slope) launch; be aware of cliffs or steep drops behind you, as strong wind can pull you backward."},
            {"kind": "p", "text": "Just after launch, you may have to brake hard on one side to fly straight, which is a sign that the wing is asymmetric — either through a line problem or wing damage. Investigate before flying further. After a successful clean launch, wait until safely clear of the slope before relaxing into the harness or making large pilot inputs."},
        ...
        "quiz": ["prc-3", "prc-7", "prc-19", "prc-23", "prc-26", "prc-38"],
    })
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "A wet wing weighs several kilograms more than a dry one. It is harder to inflate, needs a longer run and is more prone to stall during the take-off run. Its stability characteristics in stable flight, however, are not significantly changed once you are airborne. Avoid launching a wet wing in marginal conditions: the stall risk is concentrated in the launch itself and the first seconds of flight."},
            {"kind": "h2", "text": "High-altitude take-off"},
            {"kind": "p", "text": "Air is thinner at altitude. To generate the same lift the wing needs a higher airspeed — which means a faster run and a longer take-off distance. Plan for it: choose a steeper slope, accept a longer ground roll, and do not over-brake on lift-off. At very high altitudes, even moderate fitness can be enough to keep the airspeed needed for a clean launch."},
            ...
            {"kind": "p", "text": "A knot on the front (A) lines reduces the angle of attack on that side. The wing is prone to collapse on the affected side. The consequence is a sudden asymmetric collapse soon after launch, with a turn toward the knotted side. In both cases, if altitude allows, land as soon as possible to inspect and clear the knot."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "On a long flight, a few habits add up. Keep a running mental list of alternate landings reachable from your current altitude. Track the wind direction from drift, vegetation and water surfaces, and update it every time you climb. Drink water regularly — dehydration makes you slow and irritable. And keep a margin: an attempted glide that just barely works in still air will fail with the slightest unexpected sink."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Big ears are made by pulling the outer A lines on each side symmetrically. The wingtips collapse inward, reducing area and increasing sink to 3 to 4 m/s while keeping horizontal flight. There is no load-factor increase. On release, the wing returns to normal flight, with a slight parachutal stall risk during the transition. Combined with the speed bar, big ears give an even faster descent rate."},
            ...
            {"kind": "p", "text": "A full stall (brakes pulled too far) makes the wing lose its arch and deflate — extremely dangerous, only to be practised over water under SIV instruction. A parachutal stall is a state in which the wing keeps its shape but no air flows on the leading edge: brakes feel slack, lower surface goes slightly concave, vertical descent is high but airspeed is almost zero. Recover by pulling the A risers to surge the wing into normal flight; near the ground, prepare for a parachute landing."},
            ...
            {"kind": "p", "text": "Reserve deployment is indicated when the wing is uncontrollable or after a collision. Throw the reserve, then pull the B or C lines on the main wing to stop it from flying and tangling with the reserve. Sink rate under reserve is about 5 to 6 m/s — equivalent to a 1.5 m drop — and you should land with a parachute landing roll."},
    ...
    chapters.append({
        ...
        "sections": [
            ...
            {"kind": "p", "text": "Emergency landing priorities, best to worst: tree, sloped roof, water. Tree landings: stay roped or secured until rescue — falling from branches is the leading cause of injury after a tree landing. Water unavoidable: unclip the harness before touching the water. Power lines and crops are also better than open water."},
